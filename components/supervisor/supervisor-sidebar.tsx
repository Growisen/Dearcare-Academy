...
export default function SupervisorSidebar({ isOpen, onClose, user }: SupervisorSidebarProps) {
  ...
  return (
    <div 
      ...
      className={`w-56 h-screen bg-gradient-to-b from-blue-800 to-blue-900 fixed left-0 top-0 shadow-xl z-50 
        ...
        <div className="p-4 border-b border-blue-700/30">
          <div className="flex items-center space-x-3">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-xs text-blue-200 truncate">Supervisor</p>
            </div>
          </div>
        </div>
